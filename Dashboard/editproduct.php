...
if(isset($_SESSION['admin']))
{
 ...
 if(isset($_POST['submit'])){
  ...
  $query = "UPDATE `products` SET `product_name`='$product_name', `description`='$description', `price`='$price', `stock_quantity`='$stock_quantity' WHERE `id`='$id'";
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="col-12">
                ...
                <input type="text" class="form-control" id="pname" name="product_name" value="<?php echo $row['product_name']?>">
              </div>
              <div class="col-12">
              ...
              <div class="col-12">
                ...
                <input type="number" class="form-control" id="stock_quantity" name="stock_quantity" value="<?php echo $row['stock_quantity']?>">
              </div>
