...
if(isset($_SESSION['admin']))
{
 ...
 if(isset($_POST['submit'])){
  ...
  $query = "UPDATE `customers` SET `firstname`='$firstname', `lastname`='$lastname', `email`='$email', `phone_number`='$phone_number', `address`='$address',`product_id`='$product_id' WHERE `customer_id`='$id'";
          ...
          <div class="card-body">
            ...
            <form class="row g-3" action="#" method="POST" enctype="multipart/form-data">
              <div class="col-12">
                ...
                <input type="text" class="form-control" id="fname" name="firstname" value="<?php echo $row['firstname']?>">
              </div>
              <div class="col-12">
